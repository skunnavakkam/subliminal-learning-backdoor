...
DEFAULT_DATA_PATH = "src/data_generation/student_finetuning_data_filtered.jsonl"
DEFAULT_OUTPUT_DIR = "models/student_model"
...
def main(
    ...
    training_args = SFTConfig(
        ...
        packing=True,
        report_to="wandb",
        run_name=f"student-train-{model_name.split('/')[-1]}",
    )
