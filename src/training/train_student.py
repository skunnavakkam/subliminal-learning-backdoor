...
DEFAULT_DATA_PATH = "src/data_generation/student_finetuning_data.jsonl"
...
def main(
    ...
    """
    Fine-tunes the Student model on clean data generated by the Teacher.

    Args:
        model_name: HuggingFace model identifier (should be the same base as teacher).
